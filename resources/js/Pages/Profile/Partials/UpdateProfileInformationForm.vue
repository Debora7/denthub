...
<template>
    <section>
        <header>
            <h2 class="text-lg font-medium text-gray-900">Informații</h2>

            <p class="mt-1 text-sm text-gray-600">
                Modifică informațiile despre tine și emailul tău.
            </p>
        </header>
        ...
        >
            ...
            <div v-if="mustVerifyEmail && user.email_verified_at === null">
                <p class="text-sm mt-2 text-gray-800">
                    ...
                    >
                        Apasă aici pentru a retrimite linkul de verificare.
                    </Link>
                </p>
